...
records.each do |row|
  next unless row[0] == "AuditOverview"
...
puts JSON.pretty_generate(schema_base)
puts JSON.pretty_generate(format_overlay)
puts JSON.pretty_generate(label_overlay)
puts JSON.pretty_generate(encode_overlay)
puts JSON.pretty_generate(entry_overlay_algo)
puts JSON.pretty_generate(entry_overlay_supplier)
puts JSON.pretty_generate(entry_overlay_auditor)
puts JSON.pretty_generate(information_overlay_algo)
puts JSON.pretty_generate(information_overlay_supplier)
puts JSON.pretty_generate(conditional_overlay)
